...
4. `sudo make install`
    ...
    - On Debian/Ubuntu, instead of installing files directly by `sudo make install`, you can run `cd build && cpack -G DEB && sudo dpkg -i nvim-linux64.deb` to build DEB-package and install it. This should help ensuring the clean removal of installed files.
